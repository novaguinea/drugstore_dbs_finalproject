...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <form action="<?= base_url('menu/editFebruariController'); ?>" method="post">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" href="<?= base_url('menu/editFebruariController') ?>">Save</button>
                </div>
